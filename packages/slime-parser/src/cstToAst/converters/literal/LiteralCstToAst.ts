...
export class LiteralCstToAst {
    ...
    static createLiteralAst(cst: SubhutiCst): SlimeLiteral {
        SlimeAstUtils.checkCstName(cst, SlimeParser.prototype.Literal?.name);
        const firstChild = cst.children[0];
    ...
    /**
     * NumericLiteral 终端符转 Literal AST
     */
    ...
    /**
     * StringLiteral 终端符转 Literal AST
     */
    ...
    /**
     * RegularExpressionLiteral 终端符转 Literal AST
     */
